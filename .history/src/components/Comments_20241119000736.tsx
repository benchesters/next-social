      ...
      <div className="">
        ...
        <div className="">
          ...
          <d iv className="flex flex-col gap-2">
            ...
            Morbi pretium urna mollis pulvinar ullamcorper. Suspendisse ut enim a 
            ex accumsan efficitur imperdiet nec enim. Duis iaculis facilisis nunc, sit amet faucibus sem placerat at. Cras vulputate libero sapien.
            </p>
            <div className="">
              <div className="">
              <Image src="/like.png"
